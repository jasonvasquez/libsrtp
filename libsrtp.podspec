Pod::Spec.new do |s|
  s.name             = "libsrtp"
  s.version          = "1.52"
  s.summary          = "Secure RTP (SRTP) Reference Implementation"
  ...
  s.homepage         = "https://github.com/cisco/libsrtp"
  s.license          = { :type => 'BSD' }
  s.author           = { "Jason Vasquez" => "jason@mugfu.com" }
  s.source           = { :git => "https://github.com/cisco/libsrtp.git", :tag => "v#{s.version.to_s}" }

  s.platform         = :ios, '7.0'
  s.requires_arc     = false

  s.prepare_command = <<-CMD
    # We're creating an equivalent prefix header so we don't have
    # to run the configure script each time
    touch crypto/include/config.h
  CMD
